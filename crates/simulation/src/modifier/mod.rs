//! The `Modifier` step: what a unit's officers, technologies and equipment write onto it
...
//! write; [`officers`], [`technologies`] and [`equipment`] read their own table and say which
//! units a row reaches.
