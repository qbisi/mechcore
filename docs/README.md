...
| --- | --- | --- |
| Document format | [layout](spec/document/layout.md), [state](spec/document/state.md), [battle](spec/document/battle.md), [action](spec/document/action.md), [layout replay](spec/document/layout-replay.md), [turn](spec/mechcore/turn.md), [mcfr](spec/mcfr/mcfr.md), [unit-rules](spec/simulation/unit-rules.md) | the shape of the document, `Normal form`, `Excluded fields` |
